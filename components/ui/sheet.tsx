...
/* A sliding velvet panel on --shadow-xl. Plain dim scrim, no blur. */
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-50 bg-[oklch(0.08_0.005_285/0.7)]",
  ...
  ].join(" "),
  {
    variants: {
      side: {
        ...
        left: "inset-y-0 left-0 h-full w-3/4 rounded-r-xl sm:max-w-sm data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left",
        right:
          "inset-y-0 right-0 h-full w-3/4 rounded-l-xl sm:max-w-sm data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right",
      },
    },
    defaultVariants: {
      side: "right",
