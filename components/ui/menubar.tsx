...
/*
 * The bar is a raised velour strip; its menus are the same velvet panels
 * as every popover surface (--shadow-l).
 */
  ...
  (
    ...
    <MenubarPrimitive.Portal>
      <MenubarPrimitive.Content
        ...
        className={cn(menuSurface, menuMotion, "min-w-[12rem]", className)}
        {...props}
      />
    </MenubarPrimitive.Portal>
  )
