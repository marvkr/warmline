// From SVG Logos — used via Iconify (https://iconify.design)
import type { SVGProps } from "react";

// X (Twitter) wordmark. Solid fill via currentColor so it reads black in light
// theme and inverts in dark; set text color at the call site.
